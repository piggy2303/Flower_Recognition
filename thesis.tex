...
\begin{titlepage}
	...
	\begin{titlepage}
		...
		\begin{table}[h]
			...
			\hline
			STT & kernel                   & \begin{tabular}[c]{@{}l@{}}Bộ dữ liệu \\ huấn luyện\end{tabular} & \begin{tabular}[c]{@{}l@{}}Các thông số \\ cho thuật toán\end{tabular}                                        & \begin{tabular}[c]{@{}l@{}}Phương pháp \\ tăng cường ảnh\end{tabular} & \begin{tabular}[c]{@{}c@{}}Độ chính xác\\ phân loại (\%)\end{tabular} \\ \hline
			5   & \multirow{4}{*}{linear}  & data\_01                                                         & \begin{tabular}[c]{@{}l@{}}kernel='linear',\\ decision\_function\_\\ shape = 'ovr'\end{tabular}               & không                                                                 & 64.31                                                                 \\ \cline{1-1} \cline{3-6} 
			6   &                          & data\_01                                                         & \begin{tabular}[c]{@{}l@{}}kernel='linear',\\ decision\_function\_\\ shape = 'ovr'\end{tabular}               & có                                                                    & 68.29                                                                 \\ \cline{1-1} \cline{3-6} 
			7   &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='linear',\\ decision\_function\_\\ shape = 'ovr'\end{tabular}               & có                                                                    & 72.29                                                                 \\ \cline{1-1} \cline{3-6} 
			8   &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='linear',\\ decision\_function\_\\ shape = 'ovo'\end{tabular}               & có                                                                    & 74.5                                                                  \\ \hline
			9   & \multirow{3}{*}{poly}    & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}degree=3,\\ kernel='poly',\\ decision\_function\_\\ shape = 'ovr'\end{tabular}     & có                                                                    & 63.47                                                                 \\ \cline{1-1} \cline{3-6} 
			10  &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}degree=5,\\ kernel='poly',\\ decision\_function\_\\ shape = 'ovo'\end{tabular}     & có                                                                    & 53.66                                                                 \\ \cline{1-1} \cline{3-6} 
			11  &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}degree=8,\\ kernel='poly',\\ decision\_function\_\\ shape = 'ovo'\end{tabular}     & có                                                                    & 56.75                                                                 \\ \hline
			\end{tabular}
		\end{table}	
		...
		\begin{table}[h]
			...
			\hline
			STT & kernel                   & \begin{tabular}[c]{@{}l@{}}Bộ dữ liệu \\ huấn luyện\end{tabular} & \begin{tabular}[c]{@{}l@{}}Các thông số \\ cho thuật toán\end{tabular}                                        & \begin{tabular}[c]{@{}l@{}}Phương pháp \\ tăng cường ảnh\end{tabular} & \begin{tabular}[c]{@{}c@{}}Độ chính xác\\ phân loại (\%)\end{tabular} \\ \hline
			12  & \multirow{2}{*}{rbf}     & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='rbf',\\ decision\_function\_\\ shape = 'ovr'\end{tabular}                  & có                                                                    & 61.55                                                                 \\ \cline{1-1} \cline{3-6} 
			13  &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='rbf',\\ decision\_function\_\\ shape = 'ovo'\end{tabular}                  & có                                                                    & 61.55                                                                 \\ \hline
			14  & \multirow{2}{*}{sigmoid} & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='sigmoid',\\ decision\_function\_\\ shape = 'ovo'\end{tabular}              & có                                                                    & 61.55                                                                 \\ \cline{1-1} \cline{3-6} 
			15  &                          & \begin{tabular}[c]{@{}l@{}}data\_01 \\ + data\_02\end{tabular}   & \begin{tabular}[c]{@{}l@{}}kernel='sigmoid',\\ coef0=0.5,\\ decision\_function\_\\ shape = 'ovo'\end{tabular} & có                                                                    & 61.57                                                                 \\ \hline
			\end{tabular}
		\end{table}
		...
		\begin{table}[]
			...
			\hline
			STT & \begin{tabular}[c]{@{}l@{}}Bộ dữ liệu\\ huấn luyện\end{tabular} & \begin{tabular}[c]{@{}l@{}}Các thông số \\ cho thuật toán\end{tabular}        & \begin{tabular}[c]{@{}l@{}}Sử dụng phương pháp\\ tăng cường ảnh\end{tabular} & \begin{tabular}[c]{@{}c@{}}Độ chính xác\\ phân loại (\%)\end{tabular} \\ \hline
			16  & data\_01                                                        & tol=1e-5                                                                      & không                                                                        &                                                                       \\ \hline
			17  & data\_01 + data\_02                                             & tol=1e-5                                                                      & có                                                                           &                                                                       \\ \hline
			18  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-5,\\ loss='hinge'\end{tabular}              & có                                                                           &                                                                       \\ \hline
			19  & data\_01 + data\_02                                             & tol=1e-4                                                                      & có                                                                           &                                                                       \\ \hline
			20  & data\_01 + data\_02                                             & tol=1e-3                                                                      & có                                                                           &                                                                       \\ \hline
			21  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ loss='hinge'\end{tabular}              & có                                                                           &                                                                       \\ \hline
			22  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ loss='hinge',\\ verbose=2\end{tabular} & có                                                                           &                                                                       \\ \hline
			23  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ C=2.0\end{tabular}                     & có                                                                           &                                                                       \\ \hline
			24  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ C=5.0\end{tabular}                     & có                                                                           &                                                                       \\ \hline
			25  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ C=100.0\end{tabular}                   & có                                                                           &                                                                       \\ \hline
			26  & data\_01 + data\_02                                             & \begin{tabular}[c]{@{}l@{}}tol=1e-3,\\ C=1000.0\end{tabular}                  & có                                                                           &                                                                       \\ \hline
			\end{tabular}
		\end{table}
